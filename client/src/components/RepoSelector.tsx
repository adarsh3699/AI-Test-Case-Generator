			...
			<div className="card">
				<div className="card-header">
					<div className="flex items-center space-x-4">
						<div className="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg shadow-sm">
							<LinkIcon className="w-5 h-5 text-white" />
						</div>
						<div className="flex-1">
							<h2 className="text-xl font-bold text-gray-900 mb-1">GitHub Repository</h2>
							<p className="text-gray-600 text-sm">Connect and select a repository to analyze</p>
						</div>
					</div>
				</div>
					...
					<div className="relative w-full dropdown-container">
						...
						<div className="relative">
							<button
								...
								disabled={loading}
								className="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 text-left hover:border-blue-400 hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:border-gray-300"
							>
